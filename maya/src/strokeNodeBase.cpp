...
MObject strokeNodeBase::aMinimumPoints;

MObject strokeNodeBase::aPointDensity;

MObject strokeNodeBase::aRepeats;
MObject strokeNodeBase::aRepeatOffset;
MObject strokeNodeBase::aRepeatMirror;
MObject strokeNodeBase::aRepeatOscillate;
MObject strokeNodeBase::aRepeatFan;

MObject strokeNodeBase::aRepeatSeed;
MObject strokeNodeBase::aRepeatProbability;

MObject strokeNodeBase::aRepeatRandomAngleOffset;
MObject strokeNodeBase::aRepeatRandomTangentOffset;
MObject strokeNodeBase::aRepeatRandomNormalOffset;

MObject strokeNodeBase::aSeed;

MObject strokeNodeBase::aStrokeDirection;

MObject strokeNodeBase::aPaintFlowFactor;

MObject strokeNodeBase::aEntryLength;
MObject strokeNodeBase::aExitLength;
MObject strokeNodeBase::aTransitionBlendMethod;
MObject strokeNodeBase::aLocalContact;

MObject strokeNodeBase::aBrushId;
MObject strokeNodeBase::aPaintId;
MObject strokeNodeBase::aLayerId;

MObject strokeNodeBase::aActive;
MObject strokeNodeBase::aStrokeCountFactor;

MObject strokeNodeBase::aPivotFraction;
MObject strokeNodeBase::aRepeatPivot;

MObject strokeNodeBase::aBrushTiltRamp;
MObject strokeNodeBase::aBrushTiltRangeMin;
MObject strokeNodeBase::aBrushTiltRangeMax;
MObject strokeNodeBase::aBrushTiltRange;

MObject strokeNodeBase::aBrushBankRamp;
MObject strokeNodeBase::aBrushBankRangeMin;
MObject strokeNodeBase::aBrushBankRangeMax;
MObject strokeNodeBase::aBrushBankRange;

MObject strokeNodeBase::aBrushTwistRamp;
MObject strokeNodeBase::aBrushTwistRangeMin;
MObject strokeNodeBase::aBrushTwistRangeMax;
MObject strokeNodeBase::aBrushTwistRange;

MObject strokeNodeBase::aBrushFollowStroke;

MObject strokeNodeBase::aProjection;

MObject strokeNodeBase::aBrushIdTexture;
MObject strokeNodeBase::aBrushIdRemapRamp;
MObject strokeNodeBase::aBrushIdRemapRange;
MObject strokeNodeBase::aPaintIdTexture;
MObject strokeNodeBase::aPaintIdRemapRamp;
MObject strokeNodeBase::aPaintIdRemapRange;
MObject strokeNodeBase::aPaintIdRemapIndices;
...
MObject strokeNodeBase::aTransformPivot;

MObject strokeNodeBase::aRotationTexture;
MObject strokeNodeBase::aRotationScale;
MObject strokeNodeBase::aTranslationTexture;
MObject strokeNodeBase::aTranslationSampleDistance;

MObject strokeNodeBase::aTranslationScale;
MObject strokeNodeBase::aTranslationDirection;

MObject strokeNodeBase::aOutput;
MObject strokeNodeBase::aOutCoil;
...
void strokeNodeBase::assignUVs(MDataBlock &data, std::vector<Stroke> *geom) const
{
  MMatrix inverseProjMat = data.inputValue(strokeNodeBase::aProjection).asMatrix().inverse();
...
void strokeNodeBase::getUVs(std::vector<Stroke> &strokes, MFloatArray &uVals,
...
bool strokeNodeBase::overrideBrushIds(MDataBlock &data, std::vector<Stroke> *geom) const
{

  MStatus st;
  MObject thisObj = thisMObject();
  if (!TexUtils::hasTexture(thisObj, strokeNodeBase::aBrushIdTexture))
  {
    return false;
  }
  ...
  MIntArray result;
  st = TexUtils::sampleUVTexture(thisObj, strokeNodeBase::aBrushIdTexture, uVals, vVals,
                                 strokeNodeBase::aBrushIdRemapRamp, low, high, result);
...
bool strokeNodeBase::overridePaintIds(MDataBlock &data, std::vector<Stroke> *geom) const
{

  MStatus st;
  MObject thisObj = thisMObject();
  if (!TexUtils::hasTexture(thisObj, strokeNodeBase::aPaintIdTexture))
  {
    return false;
  }
  ...
  st = TexUtils::sampleUVTexture(thisObj, strokeNodeBase::aPaintIdTexture, uVals, vVals,
                                 strokeNodeBase::aPaintIdRemapRamp, low, high, result);
  if (st.error())
  {
    return false;
  }
...
bool strokeNodeBase::rotateStrokes(
    MDataBlock &data,
    MFloatArray &uVals,
    MFloatArray &vVals,
    std::vector<Stroke> *geom) const
{
  ...
  MStatus st = TexUtils::sampleUVTexture(
      thisMObject(),
      strokeNodeBase::aRotationTexture,
      uVals,
      vVals,
      -scale,
      scale,
...
bool strokeNodeBase::translateStrokes(
    MDataBlock &data,
    MFloatArray &uVals,
    MFloatArray &vVals,
    std::vector<Stroke> *geom) const
{
  ...
  MStatus st = TexUtils::sampleUVGradient(
      thisMObject(),
      strokeNodeBase::aTranslationTexture,
      sampleDist,
      scale,
      uVals,
      vVals,
...
void strokeNodeBase::transformStrokes(MDataBlock &data, std::vector<Stroke> *geom) const
{

  MStatus st;
  MObject thisObj = thisMObject();
  bool doRotation = TexUtils::hasTexture(thisObj, strokeNodeBase::aRotationTexture);
  bool doTranslation = TexUtils::hasTexture(thisObj, strokeNodeBase::aTranslationTexture);
...
bool strokeNodeBase::getMappedColors(std::vector<Stroke> *geom, MObject &attribute,
...
{
  MFloatVectorArray result;
  if (!getMappedColors(geom, strokeNodeBase::aStrokeFilterTexture, result))
  {
    return false;
  }
  std::vector<Stroke>::iterator iter = geom->begin();
...
bool strokeNodeBase::setSortMapColor(std::vector<Stroke> *geom) const
{
  ...
  MFloatVectorArray result;
  if (!getMappedColors(geom, strokeNodeBase::aStrokeSortTexture, result))
  {
    return false;
  }
